...
import ReviewFrom from '../../components/ReviewDetails/ReviewFrom';
    ...
    return (
      ...
      <div>
        ...
        <div className="bg-white shadow-card p-3">
          ...
          <ReviewDetails/>
          {/* {selectedItem === "details" && <ReviewDetails />} */}
          {/* {selectedItem === "addNew" && <ReviewFrom setSelectedItem={setSelectedItem} />} */}
        </div>
      </div>
    </div>
        </div>
