...
import BannerFromData from '../../components/BannerDetails/BannerFromData';
      ...
      <div className="p-4">
        <div>
          <div className="flex flex-wrap items-center py-5 justify-between">
            <h1 className="text-xl font-bold mb-4">Slider Details</h1>
          ...
          <div className="bg-white shadow-card p-3">
            ...
            {selectedItem === "details" && <BannerDetails />}
            {selectedItem === "addNew" && (
              <BannerFromData setSelectedItem={setSelectedItem} />
            )}
          </div>
        </div>
      </div>
